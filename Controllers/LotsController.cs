...
namespace CarPro.Controllers
{
    public class LotsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Address,ZipCode,PhoneNum,Manager")] Lot lot)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Address,ZipCode,PhoneNum,Manager")] Lot lot)
        {
            if (id != lot.Id)
            {
                return NotFound();
